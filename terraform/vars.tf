...
variable "k3_dev_server00_mem" { default = "12120" }
variable "k3_dev_server00_cores" { default = "4" }
variable "k3_dev_server00_disksize" { default = "200G" }
variable "k3_dev_server00_host" { default = "lumiere" }
